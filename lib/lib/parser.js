...
function parseFixmFromFile(fixmFilePath, fixmversion) {
    const fixmString = fileHandler_1.readFile(fixmFilePath);
    return transformFixmToAcris(fixmString, fixmversion);
}
exports.parseFixmFromFile = parseFixmFromFile;
function transformFixmToAcris(xmlString, fixmversion) {
    ...
    ACRIS_OBJ = validator_1.validateObject(ACRIS_OBJ, VERSION);
...
function setFixmDatFromFile(fixmData, fixmVersion) {
    VERSION = fixmVersion;
